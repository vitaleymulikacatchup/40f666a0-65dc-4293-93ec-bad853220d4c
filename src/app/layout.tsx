...
export const metadata: Metadata = {
  title: "CoffeesGop - Premium Coffee Delivered Fresh",
  description: "Discover exceptional single-origin and blended coffees. Fresh roasted, sustainably sourced, delivered to your door. Join 50K+ coffee lovers.",
  keywords: "coffee, premium coffee, specialty coffee, coffee beans, coffee delivery, single origin coffee",
  openGraph: {
    title: "CoffeesGop - Premium Coffee Delivered Fresh",
    description: "Discover exceptional single-origin and blended coffees. Fresh roasted, sustainably sourced.",
    siteName: "CoffeesGop",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766065821486-4korfg8p.jpg",
      alt: "CoffeesGop Premium Coffee"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "CoffeesGop - Premium Coffee",
    description: "Fresh roasted, sustainably sourced coffee delivered to your door",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766065821486-4korfg8p.jpg"]
  }
};
